...
Label(root, text="HULK-BROWSER", font="Helvtica 24 bold",background='green').pack()
Label(root,text="(Click on the buttons to open website)",font="LUCIDA 18", background='green').pack()
